...
const ProjectsSection = () => {
    const projects = [
        ...
        { id: 2, name: 'Chat Application', img: chatApp, link: '/chatApp' },
        { id: 3, name: 'Pomodoro Clock', img: pomodoroClock, link: '/pomodoroClock' },
        { id: 4, name: 'Markdown Previewer', img: markDown, link: '/markdownPreviewer' },
    ];
